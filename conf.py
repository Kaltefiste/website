...
BLOG_AUTHOR = {"de": "Kaltefiste Kollektiv", "en": "Kaltefiste collective"}  # (translatable)
BLOG_TITLE = "Kaltefiste"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://kaltefiste.net/"
...
NAVIGATION_LINKS = {
    ...
    "en": (
        ...
        (
            (
                ("/en/projects/knecht-im-schacht", "Knecht im Schacht"),
            ), "Projects"
        ),
        ("/en/imprint/", "Imprint"),
    ),
...
DEPLOY_COMMANDS = {
    'default': [
        "rsync -rah --progress --delete output/ kf@atomic.davidak.de:/var/www/kf/web/",
    ],
#    'staging': [
#        "rsync -rah --progress --delete output/ kf@binary.lan:/var/www/kf/web/",
#    ],
}
